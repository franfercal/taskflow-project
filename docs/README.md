...
Índice de la documentación del proyecto. TaskFlow es una aplicación web para gestionar tareas y proyectos con prioridades, fechas límite, filtros y persistencia en el navegador.
...
- [README principal del proyecto](../README.md) — Descripción, tecnologías, cómo empezar y scripts.
